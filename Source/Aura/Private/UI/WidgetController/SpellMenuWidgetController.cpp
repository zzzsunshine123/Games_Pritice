...
{
	GetAuraASC()->AbilityStatusChanged.AddLambda([this](const FGameplayTag& AbilityTag,const FGameplayTag& StatusTag,const int32& level)
	{
...
[this](int32 NewSpellCount)
   {
    SpellPointsDelegate.Broadcast(NewSpellCount);
	CurrentSpellPoints=NewSpellCount;
	bool bEnableSpendPoints = false;
	bool bEnableEquip = false;
